...
class DraftTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        myData += defaultDraft()
        currentDraft = myData[0] // ***have to change this one to interact to the name of the previous view***
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCellWithIdentifier(identifier, forIndexPath: NSIndexPath)
        ...
        if let cleanDraft = currentDraft{
            ...
            func vacay(openTime: OpenTime) -> String{
                var isVacay:String = ""
                if openTime.open == openTime.close{isVacay = "휴무"}
                ...
                dBNameList += cleanDraft.bottledDPriceList.keys
                var bBPriceList:[Int] = []
                dBPriceList += cleanDraft.bottledDPriceList.values
