...
class FactoryDetailTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        if let cleanFactory = currentFactory{
            ...
            var programNameList:[String] = []
            programNameList += cleanFactory.programList
            ...
            case 2:
                ...
                let(programName) = programNameList[indexPath.row]
                cell2.FactoryProgramNameLabel.text = programName
            case 3:
                let cell3 = cell as! F_URLTableViewCell
                cell3.FactoryURLLabel.text = cleanFactory.officeURL
            default: break
            }
